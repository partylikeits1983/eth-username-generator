...
function selectWordsAndNumber(ethereumAddress) {
    return __awaiter(this, void 0, void 0, function () {
        var seed, words, wordlist, i, index, number;
        return __generator(this, function (_a) {
            seed = hashAddressToSeed(ethereumAddress);
            words = [];
            wordlist = ethers_1.ethers.wordlists.en;
            for (i = 0; i < 3; i++) {
                index = Number((seed + BigInt(i * 997)) % BigInt(2048));
                words.push(wordlist.getWord(index));
            }
            number = Number(seed % BigInt(9000)) + 1000;
            return [2 /*return*/, {
                    words: words,
                    number: number
                }];
...
function convertAddressToUsername(ethereumAddress) {
    return __awaiter(this, void 0, void 0, function () {
        var capitalizeFirstLetter, result, word1, word2, number, username, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    capitalizeFirstLetter = function (word) { return word.charAt(0).toUpperCase() + word.slice(1); };
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, selectWordsAndNumber(ethereumAddress)];
                case 2:
                    result = _a.sent();
                    word1 = result.words[0];
                    word2 = capitalizeFirstLetter(result.words[2]);
                    number = result.number.toString();
                    username = word1 + word2 + number;
